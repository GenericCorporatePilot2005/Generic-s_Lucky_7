...
local tbl = {
	...
	-- Mid-Battle
		MissionStart = {"Systems online, booting up T-417, give me a second","T-417-Knon's calibration done, waiting for energy supply.", "Another day, another region to save, bring it on!", "remember #squad, just like we practised.", "Don't forget our traning #squad.", "#self_full reporting for Vek termination #ceo_full.","Time for our Parabellum"},
		...
		PodCollected_Self = {"I got the pod, we'll see its content later","Pod's obtained, we'll see if there's someone on it later", "I'll try to keep it safe."},
	...
	-- Mech State
		...
		Mech_ShieldDown = {"I made the most of what I could with that shield, so don't worry.","There are more we that one came from, don't worry.","Better me than the civilians, that's what I say."},
	...
	-- Damage Done
		...
		Vek_Fall = {"Mind where you walk if you don't want to end like that Vek.","I doubt even my shields can protect from such fall.","I wonder how deep that fall will be."},
		...
		Bldg_Destroyed_Obs = {"What the fuck was that #main_first?!","Huh? Oh, great.","Well, now that's just fantastic."},
	...
	-- AE
		...
		Mission_Repair_Start = {"Why are my partners' mechs weakened like this, what happened?!","I personally helped with my #self_mech's repairs, I really should've helped with the other mech's...","Commander, something happened, the other mechs are barely standing!","Once my T-417 is charged up, we'll all be at a big disadvantage."},
		Mission_Hacking_NewFriend = {"A friendly Bot, finally","Hacking tower is now offline and we made a new ally, perfect.", "Welcome back to the good guys side, tin can.", "Conversion, my favorite."},	
	...
	-- Meridia
		...
		Mission_lmn_FlashFlood_Flood = {"Commander, the water will be our ally here, we gotta use it.","A weirdly efficient way to drown Vek.", "They didn't lie about the 'Flash Floods'"},
		...
		Mission_lmn_Volcanic_Vent_Erupt_Vek = {"Not even my suit could help me against that.", "Fried to the core.", "If my calculations are correct, that could tear a hole on even the strongest Vek."},
	...
	--Nautilus
		Mission_Nautilus_CrumblingReaction = {"This doesn't look good.","This whole thing is going down!",},
		Mission_Nautilus_ExcavatorDestroyed = {"We lost the Excavator.","Excavator down.",},
		Mission_Nautilus_DrillerDestroyed = {"We lost the Driller.","We'll have to continue without the Driller.",},
		Mission_Nautilus_BlastChargeDestroyed = {"The Blast Charge had to be destroyed, but not like this."},
		Mission_Nautilus_BlastChargeExploded = {"Get out of the explosion's range.","Commander, the Charge exploded as expected."},
		Mission_Nautilus_RailLayerDamaged = {"Rail Layer disabled, don't let it get damaged any further.","The Rail Layer's partially damaged, but not destroyed.",},
	...
	-- Island missions
		Mission_tosx_Juggernaut_Destroyed = {"Why are most Bots here either fragile as cardboard or almost immortal?!","Juggernaut's down.", "The last of its kind, now gone... I can relate to that."},
		Mission_tosx_Juggernaut_Ram = {"Try to avoid being on its path, I would recommend.","We could use one of them, shame this is the last one.", "If only #ceo_first had more of these."},
		Mission_tosx_Zapper_On = {"Zapper is connected.","I've been promoted from soldier to cable, what an honor...","My whole suit felt that."},
		...
		Mission_tosx_Warper_Destroyed = {"Such amazing technology, destroyed like it was nothing.","And just when I started to get used to the portals...",},
		Mission_tosx_Battleship_Destroyed = {"Into the depths it goes.","At least it wasn't an iceberg this time.",},
		Mission_tosx_Siege_Now = {"COMMANDER, WE'RE GETTING AMBUSHED, PREPARE FOR THE WORST.","Oh no.","NO NOT AGAIN PLEASE!"},
		Mission_tosx_Plague_Spread = {"My suit can resist cancer, but I'm pretty sure it won't resist THAT.","Commander, that Vek carries deadly pathogens, proceed with caution."},
